...
# Define the path
# Here, I am selecting the files that have teh extension .dpt. This needs to be change depending on your files
...
# Export data frame to work in Orange
export_csv = trans_df.to_csv (r'C:\Users\2166611p\Desktop\PhD\Python Scripts\dataframeLEGS.csv',index = False)
